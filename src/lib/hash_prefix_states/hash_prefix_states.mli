...
val signature : ?signature_kind:Mina_compile_config.signature_kind -> Field.t State.t
...
val signature_legacy :
  ?signature_kind:Mina_compile_config.signature_kind -> Field.t Legacy.State.t
...
val zkapp_body : ?chain:Mina_compile_config.signature_kind -> Field.t State.t

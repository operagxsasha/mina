...
val await : block_window_duration:Time.Span.t -> t -> validation_result option Deferred.t

val await_exn : block_window_duration:Time.Span.t -> t -> validation_result Deferred.t

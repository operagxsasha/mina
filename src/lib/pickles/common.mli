...
val ft_comm :
  ...
  -> negate:('comm -> 'comm)
  -> verification_key:'comm array Kimchi_backend_common.Plonk_verification_key_evals.t
  -> plonk:
       ( 'd
       , 'e
       , 'scalar
...
val dlog_pcs_batch :
     'total Kimchi_backend_types.Nat.t
     * ('proofs_verified, 'n, 'total) Kimchi_backend_types.Nat.Adds.t
  -> ('a, 'total, Kimchi_backend_types.Nat.z) Kimchi_backend_types.Pcs_batch.t
...
module Shifts : sig
  val tick1 :
    Backend.Tick.Field.t Kimchi_backend_types.Shifted_value.Type1.Shift.t

  val tock2 :
    Backend.Tock.Field.t Kimchi_backend_types.Shifted_value.Type2.Shift.t
end
...
module Lookup_parameters : sig
  type ('a, 'b) zero_value :=
    ...
    , 'a
    , Impls.Wrap.Field.Constant.t Kimchi_backend_types.Shifted_value.Type2.t
    , 'b Kimchi_backend_types.Shifted_value.Type2.t )
...
module Ipa : sig
  ...
  module Wrap : sig
    ...
    val compute_challenges :
      'a challenge -> (Backend.Tock.Field.t, 'a) Kimchi_backend_types.Vector.t
  ...
  module Step : sig
    ...
    val compute_challenges :
      'a challenge -> (Backend.Tick.Field.t, 'a) Kimchi_backend_types.Vector.t

    val compute_sg : ('a, Pasta_bindings.Fq.t) compute_sg

    val accumulator_check :
         ( (Pasta_bindings.Fq.t * Pasta_bindings.Fq.t)
         * (Pasta_bindings.Fp.t, 'a) Kimchi_backend_types.Vector.t )
         list
      -> bool Promise.t
  end
end
...
val tock_public_input_of_statement :
     feature_flags:
       Kimchi_backend_types.Opt.Flag.t Kimchi_backend_common.Plonk_types.Features.Full.t
  -> ( Limb_vector.Challenge.Constant.t
     , Limb_vector.Challenge.Constant.t Composition_types.Scalar_challenge.t
     , Impls.Wrap.Other_field.Constant.t

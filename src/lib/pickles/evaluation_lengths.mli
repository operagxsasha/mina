...
(** Versioned types for the evaluations. It is parametrized by the field the
    ...
    {!module:Kimchi_backend_common.Plonk_types.Evals}. When a new custom gate is added, the
 ...
 *)
type 'a t := 'a Kimchi_backend_common.Plonk_types.Evals.t

(** [default] is a value of type [int t].

    Its field values are set to [1] when they are non-optional, contains only
    [1]-values when they are containers (like {!type:Kimchi_backend_types.Vector.t})

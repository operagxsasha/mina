...
type ('prev_vars, 'widths, 'public_output, 'auxiliary_output) main_return =
  { previous_proof_statements :
      ( 'prev_vars
      , 'widths )
      Kimchi_backend_types.Hlist.H2.T(Previous_proof_statement).t
  ...
  *)
  type ( 'prev_vars
    ...
    ; prevs :
        ...
        , 'widths
        , 'heights )
        Kimchi_backend_types.Hlist.H4.T(Tag).t
    ; main :
           'a_var main_input
  ...
  module T
      (Statement : Kimchi_backend_types.Poly_types.T0)
      (Statement_value : Kimchi_backend_types.Poly_types.T0)
      (Return_var : Kimchi_backend_types.Poly_types.T0)
      (Return_value : Kimchi_backend_types.Poly_types.T0)
      (Auxiliary_var : Kimchi_backend_types.Poly_types.T0)
      (Auxiliary_value : Kimchi_backend_types.Poly_types.T0) : sig
...
include module type of Make (Kimchi_backend_types.Hlist.Id)

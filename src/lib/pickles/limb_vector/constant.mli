...
module Make (N : Kimchi_backend_types.Nat.Intf) : sig
  module A : module type of Kimchi_backend_types.Vector.With_length (N)

  val length : int

  type t = (Hex64.t, N.n) Kimchi_backend_types.Vector.vec

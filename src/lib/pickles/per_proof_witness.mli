...
type ('app_state, 'max_proofs_verified, 'num_branches) t =
  ...
  *)
  ; proof_state :
      ...
      , (scalar_challenge, Impl.Boolean.var) Kimchi_backend_types.Opt.t
      , Impl.Boolean.var
      , unit
  ...
  *)
  ...
  ; prev_challenges :
      ( (Impl.Field.t, Backend.Tick.Rounds.n) Kimchi_backend_types.Vector.t
      , 'max_proofs_verified )
...
module Constant : sig
  ...
  type ('statement, 'max_proofs_verified) t =
    ...
    ; proof_state :
        ...
        , Backend.Tick.Field.t Kimchi_backend_types.Shifted_value.Type1.t option

...
struct
  ...
  let scale_fast_msb_bits base
      (Kimchi_backend_types.Shifted_value.Type1.Shifted_value
  ...
  let scale_fast_unpack base
      (Kimchi_backend_types.Shifted_value.Type1.Shifted_value (scalar : Field.t))
  ...
  *)
  let scale_fast2 (g : G.t)
      (Kimchi_backend_types.Shifted_value.Type2.Shifted_value
  ...
  let scale_fast2' (type scalar_field)
    ...
    scale_fast2 g
      (Kimchi_backend_types.Shifted_value.Type2.Shifted_value s_parts) ~num_bits

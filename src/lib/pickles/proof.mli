        ...
        type ('messages_for_next_wrap_proof, 'messages_for_next_step_proof) t =
          { statement :
              ...
              , Backend.Tick.Field.Stable.V1.t
                Kimchi_backend_types.Shifted_value.Type1.Stable.V1.t
              , bool
              , 'messages_for_next_wrap_proof
...
val dummy :
     'w Kimchi_backend_types.Nat.t
  -> 'h Kimchi_backend_types.Nat.t
  -> 'r Kimchi_backend_types.Nat.t
  -> domain_log2:int
  -> ('w, 'h) t

module Make
    (W : Kimchi_backend_types.Nat.Intf)
    (MLMB : Kimchi_backend_types.Nat.Intf) : sig
  module Max_proofs_verified_at_most :
      module type of Kimchi_backend_types.At_most.With_length (W)
  ...
  val to_yojson_full : t Kimchi_backend_types.Sigs.jsonable
...
module Proofs_verified_2 : sig
  module T :
      module type of
        Make (Kimchi_backend_types.Nat.N2) (Kimchi_backend_types.Nat.N2)
  ...
  module Stable : sig
    module V2 : sig
      ...
      include Kimchi_backend_types.Sigs.Binable.S with type t := t
    end
  end]

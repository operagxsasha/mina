...
module Make (Impl : Snarky_backendless.Snark_intf.Run) : sig
  ...
  type ('a, 'n) t =
    'n One_hot_vector.T(Impl).t * ('a, 'n) Kimchi_backend_types.Vector.t

  val seal : Impl.Field.t -> Impl.Field.t

  val mask :
       'n One_hot_vector.T(Impl).t
    -> (Impl.Field.t, 'n) Kimchi_backend_types.Vector.t
    -> Impl.Field.t
  ...
  module Domain : sig
    ...
    *)
    val shifts :
      ...
      -> Impl.Field.t Kimchi_backend_common.Plonk_types.Shifts.t

...
val step_main :
  ...
  -> self_branches:'self_branches Kimchi_backend_types.Nat.t
  -> local_signature:
       'local_signature
       Kimchi_backend_types.Hlist.H1.T(Kimchi_backend_types.Nat).t
  -> local_signature_length:
       ('local_signature, 'proofs_verified) Kimchi_backend_types.Hlist.Length.t
  -> local_branches:
       'local_branches
       Kimchi_backend_types.Hlist.H1.T(Kimchi_backend_types.Nat).t
  -> local_branches_length:
       ('local_branches, 'proofs_verified) Kimchi_backend_types.Hlist.Length.t
  -> proofs_verified:
       ('prev_vars, 'proofs_verified) Kimchi_backend_types.Hlist.Length.t
  -> lte:('proofs_verified, 'max_proofs_verified) Kimchi_backend_types.Nat.Lte.t
  -> public_input:
       ( 'var
       , 'value
       , 'a_var
  ...
  -> known_wrap_keys:
       'local_branches
       Kimchi_backend_types.Hlist.H1.T(Types_map.For_step.Optional_wrap_key).t
  ...
  -> (   unit
      -> ( (Unfinalized.t, 'max_proofs_verified) Kimchi_backend_types.Vector.t
         , Impls.Step.Field.t
         , ( Impls.Step.Field.t
           , 'max_proofs_verified )

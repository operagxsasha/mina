...
val finalize_other_proof :
  ...
  -> step_domains:
       [ `Known of (Import.Domains.t, 'branches) Kimchi_backend_types.Vector.t
       | `Side_loaded ]
  -> zk_rows:int
  -> sponge:Step_main_inputs.Sponge.t
  -> prev_challenges:
       ( (Step_main_inputs.Impl.Field.t, 'a) Kimchi_backend_types.Vector.t
       , 'b )
  ...
  -> ( Step_main_inputs.Impl.Field.t
     ...
     , Step_main_inputs.Impl.Field.t Kimchi_backend_types.Shifted_value.Type1.t
     , ( Step_main_inputs.Impl.Field.t Kimchi_backend_types.Shifted_value.Type1.t
...
val hash_messages_for_next_step_proof :
  ...
  -> (   ( 'a
         , 's
         , (Inner_curve.t, 'b) Kimchi_backend_types.Vector.t
         , ( (Step_main_inputs.Impl.Field.t, 'c) Kimchi_backend_types.Vector.t
           , 'b )
           Kimchi_backend_types.Vector.t )
...
val verify :
     proofs_verified:(module Kimchi_backend_types.Nat.Add.Intf with type n = 'a)
  -> is_base_case:Step_main_inputs.Impl.Boolean.var
  -> sg_old:
       (Impls.Step.Field.t Tuple_lib.Double.t, 'a) Kimchi_backend_types.Vector.t
  ...
  -> feature_flags:
       Kimchi_backend_types.Opt.Flag.t Kimchi_backend_common.Plonk_types.Features.t

...
val wrap :
  ...
  -> (   ( Impls.Wrap.Impl.Field.t
         ...
         , Impls.Wrap.Impl.Field.t Kimchi_backend_types.Shifted_value.Type1.t
         , ( Impls.Wrap.Impl.Field.t Kimchi_backend_types.Shifted_value.Type1.t
  ...
  -> actual_wrap_domains:(Core_kernel.Int.t, 'c) Kimchi_backend_types.Vector.t
  ...
  -> ( 'b
     ...
     , 'max_local_max_proofs_verifieds
       Kimchi_backend_types.Hlist.H1.T
...
val combined_inner_product :
  ...
  -> actual_proofs_verified:
       (module Kimchi_backend_types.Nat.Add.Intf
          with type n = 'actual_proofs_verified )
  -> ( Backend.Tick.Field.t array * Backend.Tick.Field.t array
     , Backend.Tick.Field.t array * Backend.Tick.Field.t array )
     Kimchi_backend_common.Plonk_types.All_evals.With_public_input.t
  -> old_bulletproof_challenges:
       ( (Backend.Tick.Field.t, 'a) Kimchi_backend_types.Vector.t
       , 'actual_proofs_verified )
       Kimchi_backend_types.Vector.t
...
module Type1 :
    module type of
      Plonk_checks.Make
        (Kimchi_backend_types.Shifted_value.Type1)

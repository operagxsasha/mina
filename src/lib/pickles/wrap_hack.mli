module Padded_length = Kimchi_backend_types.Nat.N2

val pad_accumulator :
     ( Backend.Tock.Proof.Challenge_polynomial.t
     , 'a )
...
val hash_messages_for_next_wrap_proof :
     'n Kimchi_backend_types.Nat.t
  -> ( Backend.Tick.Curve.Affine.t
     , ( ( Backend.Tock.Field.t
         , Kimchi_backend_types.Nat.z Backend.Tock.Rounds.plus_n )
         Kimchi_backend_types.Vector.t
       , 'n )
       Kimchi_backend_types.Vector.t )
...
val pad_challenges :
  ...
  -> ( ( Backend.Tock.Field.t
       , Kimchi_backend_types.Nat.z Backend.Tock.Rounds.plus_n )
       Kimchi_backend_types.Vector.t
     , Kimchi_backend_types.Nat.z Padded_length.plus_n )
     Kimchi_backend_types.Vector.t
